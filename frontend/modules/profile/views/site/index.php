...
$img = yii::getAlias('@frontend/web/folderuser/'.Yii::$app->user->identity->id.'profile.png');
$img_s = 'frontend/web/folderuser/'.Yii::$app->user->identity->id.'profile.png';
if(!file_exists($img))
{
    $img_s = Yii::$app->homeUrl.'css/img/profile.png';
}
    ...
    <div class="col-md-6 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="row">
                     <?= Html::img(Yii::$app->homeUrl.$img_s.'?'.time(), ['id'=>'profile1', 'class'=>'thumbnail img-responsive'])?>
                </div>
                <div class="clearfix"></div>
            </div>
    </div>
